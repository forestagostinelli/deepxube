...
def get_pathfind_from_arg(domain: Domain, pathfind_fns: PFNs, pathfind_name_args: str) -> Tuple[PathFind, str, str]:
    ...
    if args_str is not None:
        pathfind_name_args_full = f"{pathfind_name_args_full}.{args_str}"

    return pathfinding_factory.build_class(pathfind_name, pathfind_kwargs), pathfind_name, pathfind_name_args_full
